            ...
            >
              ...
              <CardContent>
                <Typography component="p" variant="body1">
                  Hello! My name is Rafael Perez (You guys can call me 'Raf') and I'm a technology enthusiast!
                  I read, draw, code, and research interesting topics. Research topic such as Quantum
                  Computing and Cybersecurity. Currently I'm taking steps to try to take action in many issues
                  that is taking place in Philly and the nation as a whole.
                </Typography>
                <Collapse
                  in={showMore}
                  sx={{
                ...
                >
                  <Typography component="p" variant="body1">
                    I like to listen to music (I would like to show a smart way to show the statistics through youtube music)
                  </Typography>
                </Collapse>
              </CardContent>
